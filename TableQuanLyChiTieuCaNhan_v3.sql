...
GO
ALTER SEQUENCE Seq_NganSach RESTART WITH 1;
GO
-- ====================================================================
...
('nguyenson', 'nguyenson@gmail.com', 'son137', 'user'),
('lehai', 'lehai@outlook.com', 'hai456', 'admin'),
('tranbao', 'tranbao@gmail.com', 'bao781', 'user'),
('hoanghen', 'hoanghen@gmail.com', 'hen123', 'user'),
('ngocbui', 'ngocbui@outlook.com', 'ngoc123', 'user'),
('phuonglinh', 'phuonglinh@gmail.com', 'linh123', 'user'),
('thaomai', 'thaomai@outlook.com', 'mai123', 'admin'),
('namhieu', 'namhieu@gmail.com', 'hieu123', 'user'),
('khanhnguyen', 'khanhnguyen@yahoo.com', 'khanh123', 'user'),
('anhduong', 'anhduong@gmail.com', 'duong123', 'admin'),
('vuhien', 'vuhien@gmail.com', 'hien123', 'user'),
('vithanh', 'vithanh@outlook.com', 'thanh456', 'user'),
('nguyenhuyen', 'nguyenhuyen@yahoo.com', 'huyen123', 'admin'),
('dongnhi', 'dongnhi@gmail.com', 'nhi789', 'user'),
('tuananh', 'tuananh@gmail.com', 'anh123', 'user');
GO

-- 4.2 Thêm dữ liệu NguoiDung_SDT
INSERT INTO NguoiDung_SDT (NguoiDung_ID, SDT) VALUES
('ND03', '0901234567'), ('ND03', '0912945678'), ('ND06', '0973456789'), 
('ND06', '0934567890'), ('ND09', '0745678901'), ('ND09', '0955555555'), 
('ND12', '0977890123'), ('ND12', '0978601234'), ('ND01', '0944444444'), 
('ND02', '0987654621'), ('ND04', '0934567890'), ('ND05', '0933333333'), 
('ND07', '0981234567'), ('ND08', '0912385678'), ('ND10', '0922222222'), 
('ND11', '0945688901'), ('ND13', '0977901234'), ('ND14', '0911111111'), 
('ND15', '0990193456');
GO

-- 4.3 Thêm dữ liệu ViTien
INSERT INTO ViTien (Ten_vi, Loai_vi, So_du_hien_tai, Ngay_tao, ID_nguoi_dung) VALUES
('Sacombank', 'The vat ly', 12300000, '2023-09-01', 'ND01'),
('BIDV', 'The vat ly', 13450000, '2022-05-15', 'ND02'),
('Techcombank', 'The vat ly', 2211500, '2024-03-07', 'ND03'),
('Vietcombank', 'The vat ly', 78100000, '2021-12-20', 'ND04'),
('ACB', 'The vat ly', 10200000, '2024-01-11', 'ND05'),
('Vietinbank', 'The vat ly', 1650000, '2020-06-10', 'ND06'),
('Agribank', 'The vat ly', 21900000, '2022-08-04', 'ND07'),
('Momo', 'Vi dien tu', 3450000, '2024-02-15', 'ND08'),
('VNPay', 'Vi dien tu', 14300000, '2023-11-25', 'ND09'),
('ZaloPay', 'Vi dien tu', 12650000, '2021-04-30', 'ND10'),
('AirPay', 'Vi dien tu', 12165000, '2020-12-18', 'ND11'),
('ShopeePay', 'Vi dien tu', 49530000, '2023-01-02', 'ND12'),
('Tien mat', 'Tien mat', 38850000, '2022-07-09', 'ND13'),
('Tien mat', 'Tien mat', 5720000, '2021-10-13', 'ND14'),
('Tien mat', 'Tien mat', 4100000, '2024-09-27', 'ND15');
GO
...
-- Chi tiêu
('Mua sam tai sieu thi', 400000, '2025-04-01', 'Mua thuc pham', 'ND01', 'DM01', 'Vi01'),
